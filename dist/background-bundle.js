...
console.log(window);
localStorage.setItem(notesStorageKey, '{"notes" : []}'); // See if we have previously saved a state and if not, insert an empty array

var initialState = JSON.parse(localStorage.getItem(notesStorageKey) || '{"notes" : []}'); // let initialState = JSON.parse(localStorage.getItem(notesStorageKey) || '{"notes"}')
