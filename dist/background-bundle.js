...
var notesApp = function notesApp() {
  ...
  switch (action.type) {
    ...
    case "ADD_TEXT":
      ...
      return Object.assign({}, state, {
        notes: state.notes.map(function (note, id) {
          if (note.id === action.id) {
    ...
    case "ADD_NOTE":
      ...
      console.log("Adding note @ page: " + action.page); // Generates a random position on the page
      ...
      console.log(state[page] == null); // If there are notes already on the page 

      if (state[page] == null) {
        return Object.assign({}, state, Object(_home_joe_Documents_web_dev_sticky_notes_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])({}, page, {
          notes: [{
            id: action.id,
            position: {
              x: posx,
        ...
        return Object.assign({}, state, Object(_home_joe_Documents_web_dev_sticky_notes_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])({}, page, {
          notes: Object(_home_joe_Documents_web_dev_sticky_notes_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(state[page].notes).concat([{
            id: action.id,
            position: {
              x: posx,
              y: action.y_position
