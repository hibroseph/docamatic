...
import { updateNotePosition, updateNoteSize, addTrackingEvent } from "../redux/actions";
...
export const NoteList = (props) => {
  ...
  useEffect(() => {
    console.log("disconnected changed in notelist " + props.disconnected);
  }, [props.disconnected]);
  return (
    <div>
      {props.url &&
...
const mapDispatchToProps = (dispatch) => ({
  metric: (event, data) => dispatch(addTrackingEvent(event, data)),
  mutateNote: (props) => {
    let action;
